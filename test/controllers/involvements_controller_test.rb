...
class InvolvementsControllerTest < ActionController::TestCase
  ...
  test "should create involvement" do
    assert_difference('Involvement.count') do
      post :create, involvement: { article_id: @involvement.article_id, details: @involvement.details, publisher_id: @involvement.publisher_id }
    end
  ...
  test "should update involvement" do
    patch :update, id: @involvement, involvement: { article_id: @involvement.article_id, details: @involvement.details, publisher_id: @involvement.publisher_id }
    assert_redirected_to involvement_path(assigns(:involvement))
  end
