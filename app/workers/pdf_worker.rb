class PdfWorker
    ...
    def perform(id, uuid, type='raw_print')
       ...
       if !article.blank?
         ...
         system("wkhtmltopdf --page-size Letter --viewport-size 1280x1024 #{Rails.application.routes.default_url_options[:host]}/articles/#{type}/#{id} #{Rails.root}/public/pdfs/#{id}/#{uuid}.pdf")
